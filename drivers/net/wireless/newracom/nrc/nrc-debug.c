...
static struct device *nrc_dbg_dev;
...
static u32 lb_hexdump;
static s64 tx_time_first;
static s64 tx_time_last;
static s64 rcv_time_first;
static s64 rcv_time_last;
static u32 arv_time_first;
static u32 arv_time_last;
static struct lb_time_info *time_info_array;
#endif
