...
extern struct nrc_trx_handler * const nrc_tx_handlers[];
extern const size_t nrc_tx_handlers_count;
extern struct nrc_trx_handler * const nrc_rx_handlers[];
extern const size_t nrc_rx_handlers_count;
extern struct nrc_sta_handler * const nrc_sta_handlers[];
extern const size_t nrc_sta_handlers_count;
